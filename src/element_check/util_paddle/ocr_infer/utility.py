...
MODEL_FILE_ROOT_DIR = os.path.join('models', 'infer_model')
if not os.path.exists(MODEL_FILE_ROOT_DIR):
    base_path = __dir__.split("src")[0]
    MODEL_FILE_ROOT_DIR = base_path + MODEL_FILE_ROOT_DIR
    logging.info("路径不存在 : {},重构路径！".format(MODEL_FILE_ROOT_DIR))
...
def init_args():
    ...
    parser.add_argument("--det_model_dir", type=str,default=MODEL_FILE_ROOT_DIR+'/ch/ch_PP-OCRv2_det_infer')
    ...
    parser.add_argument("--rec_model_dir", type=str,default=MODEL_FILE_ROOT_DIR+'/ch/ch_PP-OCRv2_rec_infer')
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default=MODEL_FILE_ROOT_DIR+"/ch/ppocr_keys_v1.txt")
    ...
    parser.add_argument("--cls_model_dir", type=str,default=MODEL_FILE_ROOT_DIR+'/ch/ch_ppocr_mobile_v2.0_cls_infer')
...
def create_predictor(args, mode):
    ...
    if model_dir is None:
        logging.info("not find {} model file path {}".format(mode, model_dir))
        sys.exit(0)
